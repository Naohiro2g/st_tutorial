...
def render():
    st.header("Demo 01  QR Code Generator")
    st.write("You can generate a QR code from a string or URL. QRコードを文字列かURLから生成することができます。")
    st.text('PyQRCodeNG version')
    st.info("keywords: st.text_input st.image st.select_slider")
